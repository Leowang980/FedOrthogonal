...
if __name__=='__main__':
    ...
    if args.dataset=='CIFAR10':
        args.num_classes=10
        dataloader_train_dict, dataloader_test_dict, train_len_dict, test_len_dict=cifar10_noiid(args=args,root='D:/code/fed/data/cifar10')
        dataloader_distill=cifar100_distill(args=args,root='D:/code/fed/data/cifar100')
        dataloader_train_global, dataloader_test_global=cifar10_global(args=args, root='D:/code/fed/data/cifar10')
        ...
        dataloader_distill=tiny_imagenet_distill(args=args,root='/home/ycli/Dataset/CIFAR100')
    ...
    if args.method == 'FedAvg':
        ...
        fed=HeteroFL(args, model, dataloader_train_dict, dataloader_test_dict, 
                    dataloader_test_global, train_len_dict, test_len_dict) 
    elif args.method in ['FedOrthogonalLogit', 'FedOrthogonal', 'FedLinearLogit', 'FedLinear']:
